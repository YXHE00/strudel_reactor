...
It also allowes to save and search song using JSON handling and uses D3 visualisation to show drums in action.
...
-**Save/Search**
	- Song name input: type a name for current song
	- Save button:
...
---
## AI
![InputPattern issue](./ReadMe/img/InputPattern.png)
![String line](./ReadMe/img/stringline1.png)
![String line](./ReadMe/img/stringline2.png)
![localStorage](./ReadMe/img/localStorage1.png)
![localStorage](./ReadMe/img/localStorage2.png)
